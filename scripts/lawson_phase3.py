...
def generate_plan(ball_pos, tool_pos):
	...
	start_mode = create_control_mode(0)
	plan.modes.append(start_mode)
	...
	ab_mode = create_control_mode(0)
	plan.modes.append(ab_mode)
	...
	plan.points.append(above_drop)
	rad_mode = create_control_mode(0)
	plan.modes.append(rad_mode)
